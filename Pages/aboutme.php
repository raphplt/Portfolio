...
<?php
    ...
    ?>
      <div class="info"> <?php echo $data['Firstname']??''; ?> <?php echo $data['Lastname']??''; ?> </div>
      <div class="info">Email : <?php echo $data['Email']??''; ?></div>
      <div class="info">Phone : <?php echo $data['Phone']??''; ?></div>
      <div class="info">Address : <?php echo $data['Address']??''; ?></div>
      <div class="info"> <?php echo $data['City']??''; ?>, <?php echo $data['Country']??''; ?> </div>
      <div class="info"><?php echo $data['Birth_date']??''; ?> </div>
...
<img src="../Medias/photo.png" class="picture_of_me" alt="picture_of_me">
</div>
